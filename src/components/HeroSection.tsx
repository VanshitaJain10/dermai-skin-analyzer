			...
			<div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10 py-20">
				<div className="max-w-4xl mx-auto text-center">
					...
					<h1 className="font-heading text-4xl sm:text-5xl lg:text-6xl font-extrabold text-foreground leading-tight mb-6 animate-fade-up">
						...
						<span className="gradient-text">AI-Based Disease</span> Detection
					</h1>
					...
					>
						DermAI uses advanced deep learning to analyze skin lesions and
						identify potential conditions from 10 disease categories — instantly
						and privately.
					</p>
					...
					{/* Stats */}
					<div
						className="grid grid-cols-1 sm:grid-cols-3 gap-4 max-w-2xl mx-auto animate-fade-up"
