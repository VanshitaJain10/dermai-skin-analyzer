      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-14">
          ...
          <p className="text-muted-foreground max-w-xl mx-auto">
            DermAI can identify and classify these ten dermatological conditions from uploaded skin lesion photographs.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5 gap-5">
          {diseases.map((disease) => (
            ...
            >
              {/* Image Placeholder */}
              <div className={`h-36 bg-gradient-to-br ${disease.color} flex items-center justify-center relative overflow-hidden`}>
                {/* Decorative circles */}
                ...
                <div className={`w-16 h-16 rounded-full bg-white/70 flex items-center justify-center shadow-sm z-10`}>
                  <span className={`font-heading font-extrabold text-base ${disease.textColor}`}>
                    {disease.shortName}
                  </span>
                </div>
              </div>
